...
void rsl_compareTMP(const std::string& path){
    ...
    std::string inputFile100 = path + "/abs25_fitCLG1.txt";
...
//    TGraph* scatterGraph150 = new TGraph(num, dis150, mpv150);
    ...
    legend->AddEntry(scatterGraph100, "Abs = 15m", "pe");
...
//Drawing 2-------------------------------------------------------------------
    ...
    legend2->AddEntry(graphDiff100, "Abs25 - Abs20", "pe");
...
//Drawing 3-------------------------------------------------------------------
    ...
    graphBias50->GetYaxis()->SetRangeUser(-5, 5);
...
//    graphBias70->GetYaxis()->SetTitle("2*(ABSxx - ABS20)/(ABSxx + ABS20)");
//    graphBias70->GetXaxis()->SetRangeUser(0, 300);
    ...
    legend3->AddEntry(graphBias50, "ABS10", "pe");
    legend3->AddEntry(graphBias70, "ABS15", "pe");
    legend3->AddEntry(graphBias100, "ABS20", "pe");
    legend3->AddEntry(graphBias150, "ABS30", "pe");
    legend3->Draw();
...
void rsl_compare_m1(){
    ...
    //For membrane1---
    rsl_compareTMP("/Users/shuaixiangzhang/Work/current/FNAL_Work2024/rsl_analyses/v4_analysis/abs_explore/results/e67_3000events_crtCut/fit_results/m1");
